...
Aadd(aFields,{"DT_PRODUTO"   ,"C",OemToAnsi("Produto")})
Aadd(aFields,{"DT_DESCRI"    ,"C",OemToAnsi("Descricao")})
Aadd(aFields,{"DT_QUANT"     ,"N",OemToAnsi("Qtde"),"@E 9999999999.9999"})
Aadd(aFields,{"DT_VUNIT"     ,"N",OemToAnsi("Unitario"),"@E 99,999,999.99"})
Aadd(aFields,{"DT_VALOR"     ,"N",OemToAnsi("Total"),"@E 999,999,999.99"})
Aadd(aFields,{"DT_SOLICIT"   ,"C",OemToAnsi("Solicitante")})
Aadd(aFields,{"DT_EMISSAO"   ,"D",OemToAnsi("Emissao")})
Aadd(aFields,{"DT_LOGIN"     ,"C",OemToAnsi("Responsavel")})
Aadd(aFields,{"DT_ATENCAO"   ,"D",OemToAnsi("Status")})
*/
...
While !DET->(eof())
	...
	@ Prow()    , 015 Psay 	DET->DT_NUM
	@ Prow()    , 024 Psay 	DET->DT_ITEM
	@ Prow()    , 030 Psay 	Substr(DET->DT_PRODUTO,1,10)
	...
	//@ Prow()    , 146 Psay 	Substr(DET->DT_SOLICIT,1,10)
	//@ Prow()    , 157 Psay 	DET->DT_EMISSAO

	@ Prow()    , 170 Psay 	DET->DT_ANEXO
	@ Prow()    , 176 Psay 	DET->DT_OBS     
