...
±±ºPrograma  ³PCP046 Autor:José Henrique M Felipetto Data: 28/12/11       º±±
...
oPrn:Say(nAlt,nLar + 1050,"APONTAMENTO DE PRODUÇÃO DE  " + DTOC(mv_par01) + " ATÉ " + DTOC(mv_par02) ,oFnt1)
...
oPrn:Say(nAlt + 160, nLar + 390,"Operação ",oFnt1)
oPrn:Say(nAlt + 160, nLar + 785,"Ordem de Produção",oFnt1)
