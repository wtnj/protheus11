...
If DbSeek(xFilial()+cPecaRev)
	...
	If Empty(cPecaAuto)
		MsgRun("Gerando Visualizacao, Aguarde...","",{|| CursorWait(), fMontaRel(oPrint) ,CursorArrow()}) //"Gerando Visualizacao, Aguarde..."
	Else
		fMontaRel(oPrint)
	Endif
...
While !_QRY->(EOF())
	...
	EndIf 
		...
		For nxCont := 1 To Len(aTxt)   
			...
			IIF(nTamPapel == 1, oPrint:SayBitmap(nLinha1-15,1305,cAmarelo,1670,50,,.T.),;
								oPrint:SayBitmap(nLinha1-15,2005,cAmarelo,2340,70,,.T.))
...
IIF(nTamPapel == 1, oPrint:Line( 50, 1200, 150, 1200 ), oPrint:Line( 50, 1830, 250, 1830 ))   	// vertical 1830 
IIF(nTamPapel == 1, oPrint:Line( 50, 1500, 150, 1500 ), oPrint:Line( 50, 2210, 250, 2210 ))   	// vertical 2210
IIF(nTamPapel == 1, oPrint:Line( 50, 1900, 250, 1900 ), oPrint:Line( 50, 2600, 450, 2600 ))  // vertical    2600
IIF(nTamPapel == 1, oPrint:Line( 50, 2500, 250, 2500 ), oPrint:Line( 50, 3650, 450, 3650 ))  // vertical    3650
IIF(nTamPapel == 1, oPrint:Line( 50, 3000, 150, 3000 ), oPrint:Line( 50, 4420, 250, 4420 )) // vertical     4420
...
// Descricao cabecalho 
//cFileLogo	:= "logo_whb.bmp" 
cFileLogo	:= "lgrl02.bmp" 
IIF(nTamPapel == 1, oPrint:SayBitmap(060,0040,cFileLogo,100,200,,.T.),;
					oPrint:SayBitmap(070,0070,cFileLogo,20,100,,.T.))	
...
IIF(nTamPapel == 1, oPrint:Say(060,0950,"PROTOTIPO",oFontCou08 ), oPrint:Say(070,1460,"PROTOTIPO",oFontCou12 ))   
IIF(nTamPapel == 1, oPrint:Say(110,1050,Iif(_QRY->QKL_TPPRO == "1","(X)","( )"),oFont08 ),;		
					oPrint:Say(170,1460,Iif(_QRY->QKL_TPPRO == "1","(X)","( )"),oFont12 )) 
					 
IIF(nTamPapel == 1, oPrint:Say(060,1250,"PRÉ-SÉRIE",oFontCou08 ),	oPrint:Say(070,1840,"PRÉ-SÉRIE",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(110,1350,Iif(_QRY->QKL_TPPRO == "2","(X)","( )"),oFont08 ),; 		
					oPrint:Say(170,1840,Iif(_QRY->QKL_TPPRO == "2","(X)","( )"),oFont12 )) 
					
IIF(nTamPapel == 1, oPrint:Say(060,1550,"PRODUÇÃO",oFontCou08 ), 	oPrint:Say(070,2220,"PRODUÇÃO",oFontCou12 ))  
IIF(nTamPapel == 1, oPrint:Say(110,1650,Iif(_QRY->QKL_TPPRO == "3","(X)","( )"),oFont08 ),; 		
					oPrint:Say(170,2220,Iif(_QRY->QKL_TPPRO == "3","(X)","( )"),oFont12 )) 

IIF(nTamPapel == 1, oPrint:Say(060,2000,"N.   DOC.:",oFontCou08 ), 			oPrint:Say(070,2610,"N.   DOC.:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(110,2000,_QRY->QKL_PLAN,oFont08 ), 			oPrint:Say(170,2610,_QRY->QKL_PLAN,oFont12 )) 
IIF(nTamPapel == 1, oPrint:Say(060,2650,"PROCESSISTA/RAMAL:",	oFontCou12 ), 	oPrint:Say(070,3660,"PROCESSISTA/RAMAL:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(110,2650,_QRY->QKL_PROC +  " / " + _QRY->QKL_RAMAL,	oFont12 ),oPrint:Say(170,3660,_QRY->QKL_PROC +  " / " + _QRY->QKL_RAMAL,oFont12 )) 
IIF(nTamPapel == 1, oPrint:Say(060,3050,"FOLHA:",oFontCou08 ), 				oPrint:Say(070,4430,"FOLHA:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(110,3050,STR(i),oFont12 ), 					oPrint:Say(170,4430,STR(i),oFont12 )) 

//Segunda Linha
IIF(nTamPapel == 1, oPrint:Say(160,0070,"CÓDIGO WHB/REV.",oFontCou08 ),oPrint:Say(260,0055,"CÓDIGO WHB/REV.",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,0070,Alltrim(QK1->QK1_PECA)+" / "+QK1->QK1_REV,oFont08 ),;
					oPrint:Say(360,0070,Alltrim(QK1->QK1_PECA)+" / "+QK1->QK1_REV,oFont12 )) 
IIF(nTamPapel == 1, oPrint:Say(160,0420,"N. PEÇA CLIENTE:",oFontCou08 ), oPrint:Say(260,610,"N. PEÇA CLIENTE:",oFontCou12 ))
IIF(nTamPapel == 1, oPrint:Say(210,0420,QK1->QK1_PCCLI,oFont08 ), oPrint:Say(360,610,QK1->QK1_PCCLI,oFont12 )) 
IIF(nTamPapel == 1, oPrint:Say(160,0800,"DENOMINAÇÃO:",oFontCou08 ), 	oPrint:Say(260,1060,"DENOMINAÇÃO:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,0800,Subs(QK1->QK1_DESC,1,60),oFont08 ), 	oPrint:Say(360,1060,Subs(QK1->QK1_DESC,1,60),oFont12 ))
IIF(nTamPapel == 1, oPrint:Say(160,1400,"CLIENTE:",oFontCou08 ), 		oPrint:Say(260,1710,"CLIENTE:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,1400,Subs(SA1->A1_NOME,1,22),oFont08), 		oPrint:Say(360,1710,Subs(SA1->A1_NOME,1,22),oFont12 ))
 
IIF(nTamPapel == 1, oPrint:Say(160,1900,"MAQUINA:",oFontCou08 ), 		oPrint:Say(260,2610,"MAQUINA:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,1900,_QRY->QKK_MAQ,oFont08 ), 		oPrint:Say(360,2610,_QRY->QKK_MAQ,oFont12 ))  
IIF(nTamPapel == 1, oPrint:Say(160,2300,"OPERAÇÃO:",oFontCou08 ), 		oPrint:Say(260,3110,"OPERAÇÃO:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,2300,_QRY->QKK_NOPE,oFont08 ), 		oPrint:Say(360,3110,_QRY->QKK_NOPE,oFont12 )) 
IIF(nTamPapel == 1, oPrint:Say(160,2550,"DATA   EMISSÃO:",oFontCou08 ),oPrint:Say(260,3660,"DATA EMISSÃO:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(210,2550,"",oFont08 ),oPrint:Say(360,3660,"",oFont12 )) 
...
IIF(nTamPapel == 1, oPrint:Say(210,2870,Subs(Alltrim(_QRY->QKL_APRFOR),1,20)+" / "+cQKL_DTAFOR,oFont12 ),; 
					oPrint:Say(360,4010,Subs(Alltrim(_QRY->QKL_APRFOR),1,20)+" / "+cQKL_DTAFOR,oFont12 )) 

IIF(nTamPapel == 1, oPrint:Say(260,0060,"EQUIPE   DE   APQP:",oFontCou08 ),		oPrint:Say(460,0060,"EQUIPE DE APQP:",oFontCou12 ))
IIF(nTamPapel == 1, oPrint:Say(310,0060,_QRY->QKL_EQPRIN,oFont08 ),		oPrint:Say(460,0390,_QRY->QKL_EQPRIN,oFont12 ))     
cQKL_DTAQUA	:= SubStr(_QRY->QKL_DTAQUA,7,2) +"/"+ SubStr(_QRY->QKL_DTAQUA,5,2) +"/"+ SubStr(_QRY->QKL_DTAQUA,1,4)
...
IIF(nTamPapel == 1, oPrint:Say(310,2410,_QRY->QKL_APQUCL + " / " + cQKL_DTAQUA,oFont08 ), oPrint:Say(560,3310,_QRY->QKL_APQUCL + " / " + cQKL_DTAQUA,oFont12 )) 
...
IIF(nTamPapel == 1, oPrint:Say(310,2860,_QRY->QKL_APRFOR + " / " + cQKL_DTAFOR,oFont08 ), oPrint:Say(560,4010,_QRY->QKL_APRFOR + " / " +  cQKL_DTAFOR,oFont12 )) 


IIF(nTamPapel == 1, oPrint:Say(360,0060,"DESCRIÇÃO   DA",	oFontCou08 ), oPrint:Say(660,0060,"DESCRIÇÃO   DA",oFontCou12 ))
IIF(nTamPapel == 1, oPrint:Say(410,0060,"	OPERAÇÃO:",	oFontCou08 ), oPrint:Say(760,0060,"	OPERAÇÃO:",oFontCou12 )) 
IIF(nTamPapel == 1, oPrint:Say(410,0360,_QRY->QKK_DESC,	oFont08 ), oPrint:Say(660,0610,_QRY->QKK_DESC,oFont12 ))  
...
IIF(nTamPapel == 1, oPrint:Say(410,1930,_QRY->QKL_DESUSI + " / " + cQKL_RVDESUS,oFont08 ), 	oPrint:Say(760,2610,_QRY->QKL_DESUSI + " / " + cQKL_RVDESUS,oFont12 )) 
...
IIF(nTamPapel == 1, oPrint:Say(410,2410,_QRY->QKL_DESBRU + " / " + cQKL_RVDESBR,	oFont08 ), oPrint:Say(760,3310,_QRY->QKL_DESBRU + " / " + cQKL_RVDESBR,oFont12 ))
...
IIF(nTamPapel == 1, oPrint:Say(410,2860,_QRY->QKL_DESMON + " / " + cQKL_RVDESMO,oFont08 ), 	oPrint:Say(760,4010,_QRY->QKL_DESMON + " / " + cQKL_RVDESMO,oFont12 )) 
...
IIF(nTamPapel == 1, oPrint:Say(560,600,"DESENHO DO PRODUTO",oFontCou08), oPrint:Say(900,800,"DESENHO DO PRODUTO",oFontCou12))
IIF(nTamPapel == 1, oPrint:Say(560,1310,"ITEM",oFontCou06), oPrint:Say(900,2005,"ITEM",oFontCou12)) 

IIF(nTamPapel == 1, oPrint:Say(560,1550,"DESCRIÇÃO",oFontCou08), oPrint:Say(900,2120,"DESCRIÇÃO",oFontCou12)) 
...
IIF(nTamPapel == 1, oPrint:Say(560,2200,"TÉCNICA   DE",oFontCou08), oPrint:Say(900,3230,"TÉCNICA DE",oFontCou12)) 
IIF(nTamPapel == 1, oPrint:Say(620,2200,"AVALIAÇÃO",oFontCou08), oPrint:Say(950,3230,"AVALIAÇÃO",oFontCou12)) 

IIF(nTamPapel == 1, oPrint:Say(560,2500,"FREQ.",oFontCou08), oPrint:Say(900,3650,"FREQ.",oFontCou12)) 
...
IIF(nTamPapel == 1, oPrint:Say(560,2750,"MÉTODO   DE",oFontCou08), oPrint:Say(900,3930,"MÉTODO DE",oFontCou12)) 
IIF(nTamPapel == 1, oPrint:Say(620,2750,"CONTROLE",oFontCou08), oPrint:Say(950,3930,"CONTROLE",oFontCou12)) 

IIF(nTamPapel == 1, oPrint:Say(560,3010,"PLANO DE REAÇÃO",oFontCou08), oPrint:Say(900,4360,"PLANO DE",oFontCou12)) 
...
cAmarelo	:= "amarelo.bmp" 
IIF(nTamPapel == 1, oPrint:SayBitmap(2160,2350,cAmarelo,400,30,,.T.),;
					oPrint:SayBitmap(3035,3200,cAmarelo,600,60,,.T.))	
