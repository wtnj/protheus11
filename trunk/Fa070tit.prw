...
±±ºPrograma  ³FA070TIT  ºAutor  ³Marcos R. Roquitski º Data ³  09/16/09   º±±
c±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Ponto de entrada apos confirmacao da Baixa.                º±±
±±º          ³                                                            º±±
