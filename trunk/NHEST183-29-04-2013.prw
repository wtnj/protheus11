...
±±ºPrograma  ³NHEST183  ºAutor  ³FELIPE CICONINI     º Data ³  26/01/11   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ RELATORIO DE SALDO POR ENDEREÇO                            º±±
±±º          ³                                                            º±±
...
Local aPergs := {}
	...
	aAdd(aPergs,{"Mostra Zerados ?"   ,"N", 1,0,"C","Sim","Não","","","","",""})
...
oRelato:cCabec1 := "   CODIGO            DESCRIÇÃO                                      LOCAL       ENDEREÇO                      SALDO"
