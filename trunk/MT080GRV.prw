...
ฑฑบPrograma  ณMT080GRV  บAutor:Jos้ Henrique M Felipetto Data:08/21/12 	  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Ponto de entrada ap๓s a grava็ใo da TES                    บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Cadastro de TES/FAT         								  บฑฑ
...
//ณBloco de c๓digo que envia e-mail avisando que uma TES ณ
//ณfoi incluํda, e n oconte๚do suas informa็๕es.         ณ
...
cMsg += "&nbsp;&nbsp;Aviso de inclusใo de TES"
cMsg += "</td> </tr> "
cMsg += "<tr><td colspan='3'><ul><li>TES: " + SF4->F4_CODIGO + " </li> <li> CFOP: " + SF4->F4_CF + " </li> <li> Usuแrio: " + Alltrim(Upper(cUsername)) + " </li> </ul> "
...
oMail          := Email():New()
oMail:cMsg     := cMsg
oMail:cAssunto := "*** INCLUSรO DE TES ***"
oMail:cTo      := cTo
oMail:Envia()
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
