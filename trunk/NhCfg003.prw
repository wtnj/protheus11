...
±±ºPrograma  ³NHCFG003  ºAutor  ³Marcos R Roquitski  º Data ³  18/04/05   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Manutencao no Cadastro de Usuarios X Grupos(cadastro de    º±±
±±º          ³ produtos).                                                 º±±
...
Static Function GrvDupl()
	If !msgyesno('Duplicar os acessos de grupo do usuário '+alltrim(_LoginOri)+' para '+alltrim(_LoginDes)+'?')
		Close(DlgTabela)
		return
	Endif
...
//³Função para inclur mais de um grupo por usuário.³
//³By José Henrique Medeiros Felipetto.            ³
...
oDlg  := MsDialog():New(0,0,180,260,"Incluir vários grupos",,,,,CLR_BLACK,CLR_WHITE,,,.T.)
	...
	oSay4 := TSay():New(48,10,{||"até Grupo:"},oDlg,,,,,,.T.,,)
