...
±±ºPrograma  ³NHGPE197  ºAutor  ³Marcos R. Roquitski º Data ³  08/11/11   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Envia e-mail apos emissao do aviso previo.                  ±±
±±º          ³                                                            º±±
...
Local _cDescf  := Space(20) 
	...
	If !Empty(_cMail)
		...
		cMsg += '</head>' + CRLF
	    cMsg += '<b><font size="4" face="Courier">Funcionário em ** AVISO PRÉVIO **, favor providenciar desligamento do sistema.</font></b>' + CRLF
		cMsg += '</tr>' + CRLF
