...
±±ºPrograma  ³RGPER03   ºAutor  ³Silvia Taguti       º Data ³  23/11/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Hace la impresion de los libros de Empleados Y Obreros      º±±
±±º          ³                                                            º±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³GR03IMP  ºAutor  ³Microsiga           º Data ³  11/20/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Relatorio                                                   º±±
±±º          ³                                                            º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³Libro1    ºAutor  ³Silvia Taguti       º Data ³  23/11/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³CABEC1    ºAutor  ³Silvia Taguti       º Data ³  23/11/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
AADD(aRegs,{"¨De Chapa          ?","Chapa De           ?","From Plate         ?","mv_ch9","C", 5,0,0,"G",""          ,"mv_par09",""		     ,""		   ,""            ,""							    ,"",""				  ,""				,""			   ,"","",""	   ,""	   ,""	  ,""   ,""})
AADD(aRegs,{"¨A  Chapa          ?","Chapa At‚          ?","To Plate           ?","mv_cha","C", 5,0,0,"G",""          ,"mv_par10",""		     ,""		   ,""            ,"99999"						    ,"",""				  ,""				,""			   ,"","",""	   ,""	   ,""	  ,""   ,""})
AADD(aRegs,{"¨Situaciones       ?","Situa‡”es          ?","Situations         ?","mv_chb","C", 5,0,0,"G","fSituacao" ,"mv_par11",""		     ,""		   ,""            ,"ADFT"       			        ,"",""				  ,""				,""			   ,"","",""	   ,""	   ,""	  ,""   ,""})
AADD(aRegs,{"¨Categorias        ?","Categorias         ?","Categories         ?","mv_chc","C",10,0,0,"G","fCategoria","mv_par12",""		     ,""		   ,""            ,"*CD**HM*ST" 				    ,"",""				  ,""				,""			   ,"","",""	   ,"" 	   ,""	  ,""   ,""})
AADD(aRegs,{"¨Ano Referencia    ?","Ano de Referencia  ?","Reference Year     ?","mv_chd","C", 4,0,0,"G","NaoVazio"  ,"mv_par13",""		     ,""		   ,""            ,""           				    ,"",""				  ,""				,""			   ,"","",""	   ,""	   ,""	  ,""   ,""})
AADD(aRegs,{"¨Semestre          ?","Semestre           ?","Semestre           ?","mv_che","N", 1,0,1,"C","NaoVazio"  ,"mv_par14","1o Semestre","1o Semestre","1o Semestre" ,""           				    ,"","2o Semestre"    ,"2o Semestre"    ,"2o Semestre" ,"","",""      ,""    ,""    ,""   ,""})
AADD(aRegs,{"¨Ordem             ?","Ordem              ?","Order              ?","mv_chf","N", 1,0,1,"C",""          ,"mv_par15","Matricula"  ,"Matricula"  ,"Registration","1"          					,"","Centro de Costo","Centro de Custo","Cost Center","","","Nombre","Nome","Name",""   ,""})
...
RestArea( aAreaOld )
Return
Static function GetFilxCC(cCusto)
Local nPosCC,cFil:="  "
Local aFilCC    :=     {  	{'000','00'},; //Deve preencher aqui Centro de custo e a filial correspondente a cada centro de custo.
									{'001','01'},;
									{'002','02'},;
									{'003','03'},;
									{'004','04'},;
...
//aFilCC[n][1]  == Centro de custo
//aFilCC[n][2]  == Filial correspondente
nPosCC  :=    ASCAN(aFilCC,{|x| x[1] == alltrim(cCusto)})
If nPosCC > 0
    cFil    :=    aFilCC[nposCC][2]
Endif
