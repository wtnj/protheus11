...
if Empty( aTables )	//Nenhum arquivo importado.
	...
	if lDBF01
		...
		aAdd( aObrig, { 'JAE_APLICA$"12"'		, 'Aplicação deve ser 1 (Curso) ou 2 (Processo Seletivo).' } )
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB01", "JAE_CODIGO", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk  }, 'Validando '+aFiles[1,1] )
	...
	if lDBF02
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB02", "JAE_CODIGO+JAE_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[2,1] )
	...
	if lDBF03
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB03", "JAE_CODIGO+JAE_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[3,1] )
	...
	if lDBF04
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB04", "JAE_CODIGO+JAE_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[4,1] )
	...
	if lDBF05
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB05", "JAE_CODIGO+JAE_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[5,1] )
	...
	if !lOk
		...
		Processa( { |lEnd| ProcRegua( nRecs ), lOk := xAC10401Grv( @lEnd, aFiles[1,1] ) .and. xAC10402Grv( @lEnd, aFiles[2,1] ) .and. xAC10403Grv( @lEnd, aFiles[3,1] ) .and. xAC10404Grv( @lEnd, aFiles[4,1] ) .and. xAC10405Grv( @lEnd, aFiles[5,1] ) }, 'Gravação em andamento' )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC10401Grv( lEnd, cTitulo )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC10402Grv( lEnd, cTitulo )
Local cFilJAE	:= xFilial("JAE")	// Criada para ganhar performance
Local i			:= 0
Local cDiscip
Local cMemo
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC10403Grv( lEnd, cTitulo )
Local cFilJAE	:= xFilial("JAE")	// Criada para ganhar performance
Local i			:= 0
Local cDiscip
Local cMemo
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC10404Grv( lEnd, cTitulo )
Local cFilJAE	:= xFilial("JAE")	// Criada para ganhar performance
Local i			:= 0
Local cDiscip
Local cMemo
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC10405Grv( lEnd, cTitulo )
Local cFilJAE	:= xFilial("JAE")	// Criada para ganhar performance
Local i			:= 0
Local cDiscip
Local cMemo
