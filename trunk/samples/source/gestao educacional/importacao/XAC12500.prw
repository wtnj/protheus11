...
if Empty( aTables )	//Nenhum arquivo importado.
	...
	Processa( { |lEnd| lOk := U_xACChkInt( "TRB", "JCB_CODFIN+JCB_ANOLET+JCB_PERLET+JCB_TIPO+JCB_PARCEL", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validação do Arquivo' )
	...
	if !lOk
		...
		Processa( { |lEnd| lOk := xAC12500Grv( @lEnd ) }, 'Gravação em andamento' )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC12500Grv( lEnd )
