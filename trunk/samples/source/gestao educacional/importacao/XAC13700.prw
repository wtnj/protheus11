...
±±ºPrograma  ³xAC13700  ºAutor  ³Rafael Rodrigues    º Data ³  26/12/02   º±±
...
if Empty( aTables )	//Nenhum arquivo importado.
	...
	aAdd( aObrig, { 'Empty(JCH_HORA1) .or. U_xACIsHora(JCH_HORA1,.T.) ', 'Horário inválido.' } )
	...
	Processa( { |lEnd| lOk := U_xACChkInt( "TRB", "JCH_NUMRA+JCH_CODCUR+JCH_PERLET+JCH_TURMA+Dtos(JCH_DATA)+JCH_DISCIP+JCH_HORA1", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validação do Arquivo' )
	...
	if !lOk
		...
		Processa( { |lEnd| lOk := xAC13700Grv( @lEnd ) }, 'Gravação em andamento' )
...
±±ºPrograma  ³xAC13700GrvºAutor  ³Rafael Rodrigues   º Data ³  26/12/02   º±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC13700Grv( lEnd )
