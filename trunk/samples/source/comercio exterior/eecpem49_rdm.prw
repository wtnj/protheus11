...
Begin Sequence
   ...
   DEFINE MSDIALOG oDlg TITLE WorkId->EEA_TITULO FROM 9,0 TO 28,80 OF oMainWnd
     ...
     oFld := TFolder():New(1,1,{STR0013,STR0014,STR0015,STR0016},{"IPC","IBC","OBS","MEN"},oDlg,,,,.T.,.F.,315,127) //"Documentos Para"###"Notify's"###"Observações"###"Mensagem"
