...
WHILE .T.
  ...
  /*+--------------------------------------------------------------+
   ...
   cTitulo:=STR0001 //"EmissÒo da InstruþÒo de Despacho"
    ...
    oDlg:= oSend( MSDialog(), "New", 9, 0, 17, 45,;
    ...
    @ 45, 60 BUTTON STR0002 SIZE 34,11 ACTION (nOpcao:=2,oSend(oDlg,'End')) //"Mensagens"
...
//AADD(aVetor,{SWP->WP_REGIST,SW2->W2_MOEDA,SW7->W7_QTDE*SW7->W7_PRECO,SW4->W4_REGIMP,SY8->Y8_DES,SY8->Y8_REG_TRI})
        ...
        DI160VerFim(0)
        oPrn:Say( Linha:=Linha+90 , 50  ,STR0012 +" "+ SW6->W6_FREMOED+" "+;
                  Trans( SW6->W6_VL_FRET,AVSX3("W6_VL_FRET",6)),aFontes:TIMES_NEW_ROMAN_12) //"VALOR DO FRETE: "

        DI160VerFim(0)
        oPrn:Say( Linha:=Linha+50 , 50  ,STR0032 + SYT->YT_NOME ,aFontes:TIMES_NEW_ROMAN_12)//"IMPORTADOR: "

        DI160VerFim(0)
        oPrn:Say( Linha:=Linha+50 , 50  ,STR0013 + TRANS(SYT->YT_CGC,"@R 99.999.999/9999-99") ,aFontes:TIMES_NEW_ROMAN_12) //"C.G.C.: "
        ...
        nTotal := SW6->W6_FOB_TOT+SW6->W6_INLAND+SW6->W6_PACKING + SW6->W6_FRETEIN - SW6->W6_DESCONT
        oPrn:Say( Linha:=Linha+90 , 50  ,STR0033 +SW6->W6_FOBMOE +" "+ TRANS(nTotal,AVSX3("W6_FOB_TOT",6)),aFontes:TIMES_NEW_ROMAN_12 ) 
...
oPrn:Say( Linha:=Linha+130,  50  ,STR0029+" "+STR(DAY(dDataBase),2,0)+" de " +;
