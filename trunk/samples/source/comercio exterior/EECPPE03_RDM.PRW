...
Begin Sequence
   ...
   Define MsDialog oDlg Title cTITRPT From 9,0 To 17,50 Of oMainWnd

      @  15,05 SAY STR0011 PIXEL    //"Tipo Retatório"
      @  15,45 COMBOBOX cCombo ITEMS aCombo SIZE 80,8 PIXEL

      @  30,05 Say STR0012      Pixel //"Data Inicial"
      @  30,45 MsGet dDtIni Size 40,8  Pixel
      
      @  45,05 Say STR0013        PIXEL //"Data Final"
      @  45,45 MsGet dDtFim Size 40,8  PIXEL 
...
IndRegua("QRY",cWork+OrdBagExt(),"D2_DOC" ,"AllwayTrue()","AllwaysTrue()",STR0015) //"Processando Arquivo Temporário"
