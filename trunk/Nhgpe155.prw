...
±±ºPrograma  ³NHGPE155  ºAutor  ³Marcos R. Roquitski º Data ³  04/01/2010 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Lei Anti Fumo.                                             º±±
±±º          ³                                                            º±±
...
AADD(aSays,OemToAnsi("Esta rotina ir  imprimir termo Lei Anti Fumo"))
...
cType     := "ANTIFUMO  | *.DOT"
cArquivo  := "\system\antifumo.dot"
lImpress  := .F.	// Verifica se a saida sera em Tela ou Impressora
cArqSaida := "_ANTIFUMO"	// Nome do arquivo de saida
