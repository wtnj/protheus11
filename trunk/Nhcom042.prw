...
aFields := {}
   ...
   ElseIf _nPos == 4
	  ...
	  Aadd(aFields,{"DT_LOG"        ,"C",OemToAnsi("Motivo") }) 	  
...
//	aAdd(aButtons,{"CRITICA",{||fApSc()}     ,"aprovar"  ,"Aprovar"})  
	...
	aAdd(aButtons,{"CRITICA",{||U_COM42HIS(ALLTRIM(XDET->DT_PRODUTO))},"histórico","Histórico"})  
...
USER FUNCTION COM42HIS(cProd)
PRIVATE AROTINA := {{"Historico"    ,'MacomView(XDET->DT_PRODUTO)', 0 , 1 }}
