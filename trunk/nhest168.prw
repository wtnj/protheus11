...
±±ºPrograma  ³NHEST168  ºAutor  ³João Felipe da Rosa º Data ³  12/07/10   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ ACERTO DE EMPENHO DE S.A. (B2_QEMPSA)                      º±±
±±º          ³                                                            º±±
...
Private cAl   := 'QEMPSA'
	...
	Processa({|| fQuery(mvpar01) },"Gerando informações ...")
	showEmp()
...
!Nome              ! showEmp                                                 !
+------------------+---------------------------------------------------------+
!Descrição         ! Tela para alteração dos empenhos em S.A. no SB2         !
+------------------+---------------------------------------------------------+
...
Private aCol        := {}
	...
	aAdd(aHead,{'Requisições'   ,"REQ" ,                         "",06,0,'.F.','.t.','N','','V'})
...
!Nome              ! fQuery                                                  !
+------------------+---------------------------------------------------------+
!Descrição         ! Seleciona os produtos com S.A e empenho no SB2          !
!                  ! diferentes.                                             !
+------------------+---------------------------------------------------------+
!Autor             ! João Felipe da Rosa                                     !
+------------------+--------------------------------------------------------*/
...
!Nome              ! fGrv                                                    !
+------------------+---------------------------------------------------------+
!Descrição         ! Faz a Gravação das alterações no SB2                    !
+------------------+---------------------------------------------------------+
!Autor             ! João Felipe da Rosa                                     !
+------------------+--------------------------------------------------------*/
