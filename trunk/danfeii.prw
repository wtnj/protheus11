...
#DEFINE MAXITEMC   048 //-- WHB ALTERADO DE 038 PARA 048              // Máxima de caracteres por linha de produtos/serviços
...
#DEFINE MAXVALORC  012 //-- WHB ALTERADO DE 009 PARA 012              // Máximo de caracteres por linha de valores numéricos
...
For nZ := 1 To nLenDet
	...
	If (Type("oNf:_infnfe:_det[nPrivate]:_Infadprod:TEXT") <> "U" .Or. Type("oNf:_infnfe:_det:_Infadprod:TEXT") <> "U") .And. ( lImpAnfav .Or. lImpInfAd )
	    ...
	    // WHB INICIO
		//Retira os espacos do meio da variavel
	    While At("  ",cAux) > 0                  
	      cAux := Strtran(cAux,"  "," ")
	    Enddo
	    // WHB FIM
...
For nY := 1 To nLenItens
	...
	Else
		...
		oDanfe:Say(nLinha, nAuxH2/* WHB INI */ +5 /* WHB FIM */, aAux[1][7][nY], oFont08:oFont) // QUANT
		nAuxH += aTamCol[7]
