...
Local nPagina := 1,;
	...
	oFonteG1 := TFont():New("Arial"		,,15,,.T.,,,,,.F.)
   	...
   	oFonteN1 := TFont():New("Arial"		,,06,,.F.,,,,,.F.)  //Fornec/Desc
   	oFonteN2 := TFont():New("Arial"		,,06,,.T.,,,,,.F.)  
   	oFonteN3 := TFont():New("Arial"		,,08,,.F.,,,,,.F.)  //Desc peça
//   	oFonteN4 := TFont():New("Arial"		,,15,,.T.,,,,,.F.)
   	oFonteN5 := TFont():New("Arial"		,,15,,.T.,,,,,.F.)  //Data
   	oFonteN6 := TFont():New("Verdana"	,,13,,.T.,,,,,.F.)  //Cod Prod
   	oFonteN7 := TFont():New("Verdana"	,,17,,.T.,,,,,.F.)  //Qtd Prod
   	oFonteN8 := TFont():New("Arial"		,,19,,.T.,,,,,.F.)	//Titulo
   	...
   	For m := 1 To Len(aEtiq)                                                  
        ...
        Endif
        If (m+2) <= Len(aEtiq)
        	cC31 := aEtiq[m+2,1]                    	//inspeciona
            cC32 := aEtiq[m+2,2]                    	//nome cliente
            cC33 := aEtiq[m+2,3]                    	//data digitação
            cC34 := aEtiq[m+2,4]                    	//d1_desc
            cC35 := aEtiq[m+2,5]                    	//d1_cod
            cC36 := aEtiq[m+2,6]                    	//d1_lotectl
            cC37 := aEtiq[m+2,7]                    	//nQtImp
            cC38 := aEtiq[m,8]+ " / "+aEtiq[m,9]    	//d1_cod/d1_serie
            cC39 := aEtiq[m,10]                     	//d1_fornec/d1_loja
        EndIf
        m++
//-----------------------------------------------------------------\\            
	    
	    oPr:Say(nLin+080,060,"WHB",oFonteN8)
	    oPr:Say(nLin+085,610,"CONTROLE",oFonteN2)

	    oPr:Say(nLin+080,845,"WHB",oFonteN8)
	    oPr:Say(nLin+085,1395,"CONTROLE",oFonteN2)
		
		oPr:Say(nLin+085,1640,"WHB",oFonteN8)
		oPr:Say(nLin+085,2215,"CONTROLE",oFonteN2)
		
		oPr:Say(nLin+105,0605,"QUALIDADE",oFonteN2)
	    oPr:Say(nLin+105,1390,"QUALIDADE",oFonteN2)
	    oPr:Say(nLin+105,2190,"QUALIDADE",oFonteN2)
		
//	    oPr:Say(nLin+160,0920,Upper(cC11),oFonteN2)		//INSPECIONA
//	    oPr:Say(nLin+160,2100,Upper(cC21),oFonteN2)		//INSPECIONA

//	    oPr:Say(nLin+200,100 ,Replicate("-",2000),oFonteN1)
//-----------------------------------------------------------------\\
		oPr:Say(nLin+155,060,"Fornecedor:",oFonteN1)
	    oPr:Say(nLin+155,210,cC19, oFonteN1)
	    oPr:Say(nLin+155,330,Upper(cC12), oFonteN1) //NOME CLIENTE

//	    oPr:Say(nLin+260,100,"Selo Verde    - Aprovado",oFonteN12)
//	    oPr:Say(nLin+260,100,"Lote",oFonteN12)
	    
   	    oPr:Say(nLin+155,0845,"Fornecedor:",oFonteN1)
	    oPr:Say(nLin+155,0995,cC29,oFonteN1)        //COD CLIENTE
	    oPr:Say(nLin+155,1115,Upper(cC22),oFonteN1) //NOME CLIENTE
	    
	    oPr:Say(nLin+155,1630,"Fornecedor:",oFonteN1)
	    oPr:Say(nLin+155,1800,cC39,oFonteN1)         //COD CLIENTE
	    oPr:Say(nLin+155,1920,Upper(cC32),oFonteN1)  //NOME CLIENTE
...
//-----------------------------------------------------------------\\
	    //8888888888888888888|DATA|8888888888888888888\\
	    
//	    oPr:Say(nLin+140,450,"Data:", oFonteN5)
	    oPr:Say(nLin+140,510,DtoC(StoD(cC13)),oFonteN5)
	    
//	    oPr:Say(nLin+140,1650,"Data:", oFonteN5)
	    oPr:Say(nLin+140,1295,DtoC(StoD(cC23)),oFonteN5)
	    
	    oPr:Say(nLin+140,2100,DtoC(StoD(cC33)),oFonteN5)
	    
//-----------------------------------------------------------------\\

//		oPr:Say(nLin+175,0100,"Codigo Peca:",oFonteN1)
//	    oPr:Say(nLin+175,1300,"Codigo Peca:",oFonteN1)

	    oPr:Say(nLin+190,0060,cC15,oFonteN6)   	//codigo produto
	    oPr:Say(nLin+190,0845,cC25,oFonteN6)	//codigo produto
	    oPr:Say(nLin+190,1630,cC35,oFonteN6)	//codigo produto

	    oPr:Say(nLin+200,610,"NF:",oFonteN1)
	    oPr:Say(nLin+200,650,cC18,oFonteN1)

	    oPr:Say(nLin+200,1395,"NF:",oFonteN1)
	    oPr:Say(nLin+200,1435,cC28,oFonteN1)
	    
	    oPr:Say(nLin+200,2200,"NF:",oFonteN1)
	    oPr:Say(nLin+200,2240,cC38,oFonteN1)
//-----------------------------------------------------------------\\

//	    oPr:Say(nLin+255,0300,"Descrição:",oFonteN1)
//	    oPr:Say(nLin+255,1500,"Descrição:",oFonteN1)

	    oPr:Say(nLin+250,0260,cC14,oFonteN3)	//denominacao da peca
	    oPr:Say(nLin+250,1045,cC24,oFonteN3)	//denominacao da peca 
	    oPr:Say(nLin+250,1850,cC34,oFonteN3)	//denominacao da peca
	     
//-----------------------------------------------------------------\\

	    oPr:Say(nLin+275,060,"Quantidade:",oFonteN1)
	    oPr:Say(nLin+290,060,Transform(cC17,"999999"),oFonteN7)
	   
		oPr:Say(nLin+275,845,"Quantidade:",oFonteN1)
	    oPr:Say(nLin+290,845,Transform(cC27,"999999"),oFonteN7)
	    
	    oPr:Say(nLin+275,1630,"Quantidade:",oFonteN1)
	    oPr:Say(nLin+290,1630,Transform(cC37,"999999"),oFonteN7)
