...
±±ºPrograma  ³MT250SAL Autor:José Henrique M Felipetto  Data ³  01/10/12  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³  O ponto de entrada MT250SAl é executado no final da função 
A250TudoOk() que é responsável por validar as informações digitadas no 
apontamento de produção. Com este ponto de entrada o usuário poderá 
manipular os valores de saldos dos produtos a serem requisitados pelo 
apontamento em questão..                                                  º±±
±±º          ³                                                            º±±
...
//If Alltrim(Upper(Funname())) $ "NHPCP043"
	...
	For y := 1 to Len(aSaldos)
		...
		//-- o saldo retornado neste ponto de entrada não interfere no saldo do produto MOD.
