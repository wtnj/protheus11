...
oPrint:SayBitmap(80,0080, cStartPath+"\Big3.bmp",370,70)
...
oPrint:Say(490,0090,STR0013,oFont10) //"Numero do Desenho"
oPrint:Say(490,0430,QK1->QK1_NDES,oFontCou08 )

oPrint:Say(490,1000,STR0014,oFont10) //"No. Pedido de Compra"
oPrint:Say(490,1400,QKI->QKI_PEDCOM,oFontCou08 )

oPrint:Say(490,1900,STR0015,oFont10) //"Peso"
oPrint:Say(490,1990,Alltrim(QKI->QKI_PESO)+"  Kg",oFontCou08 )

oPrint:Say(570,0090,STR0016,oFont10) //"Dispositivo de Medicao"
oPrint:Say(570,0500,Subs(QKI->QKI_DISMED,1,22),oFontCou08 )
...
oPrint:Say(745,090,SM0->M0_NOME,oFontCou08 )
...
oPrint:Say(1040,1300,QK1->QK1_PROJET,oFontCou08 )

oPrint:Say(1150,090,STR0029,oFont10) //"Nota :"
oPrint:Say(1150,200,STR0030,oFont10) //"Esta peca contem alguma substancia restrita ou responsavel"
...
oPrint:Say(2120,1500,STR0084,oFont08) 	//'  (Se "NAO" - Explicacoes sao necessarias)'

oPrint:Say(2170,100,STR0058,oFont08) //"Processo de Producao / Cavidade / Molde :"
...
oPrint:Say(2460,500,QKI->QKI_COMENT,oFontCou08 )
...
oPrint:Say(2520,1100,QKI->QKI_CARAPR,oFontCou08 )
...
If !Empty(QKI->QKI_APRFUN)
	...
	Elseif	QKI->QKI_APRFUN == "1"
		oPrint:Say(2760,1850,"X",oFontCou08)
	Endif
Endif
	 
			
oPrint:Line(2700,1300,2800,1300) // vertical
...
oPrint:Say(2950,700,STR0080, oFont08) //"A copia original desse documento deve permanecer nas instalacoes"
oPrint:Say(2980,700,STR0081, oFont08) //"d