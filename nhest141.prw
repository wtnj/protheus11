...
±±ºPrograma  ³ NHEST141  ºAutor ³João Felipe da Rosa º Data ³  20/03/2009 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ RELATORIO DE CONSUMO MES A MES                             º±±
...
cString   := ""
cDesc1    := OemToAnsi("Este relatório apresenta o consumo de materiais")
cDesc2    := OemToAnsi("mês a mês.")
cDesc3    := OemToAnsi("")
tamanho   := "G"
limite    := 220
...
nLastKey  := 0
titulo    := OemToAnsi("CONSUMO MÊS A MÊS") //título
...
//				TRB->B1_CUSTD})
	...
	//pega o preço mais alto de compra do produto no mes
