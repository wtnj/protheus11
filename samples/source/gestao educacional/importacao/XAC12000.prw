...
if Empty( aTables )	//Nenhum arquivo importado.
	...
	if lDBF01
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB01", "JAH_CODIGO+JAR_PERLET", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk, lOk := U_xAC120PL( @lEnd, cLog, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[1,1] )
	...
	if lDBF02
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB02", "JAH_CODIGO+JAH_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[2,1] )
	...
	if lDBF03
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB03", "JAH_CODIGO+JAH_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[3,1] )
	...
	if lDBF04
		...
		Processa( { |lEnd| lOk := U_xACChkInt( "TRB04", "JAH_CODIGO+JAH_SEQ", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Validando '+aFiles[4,1] )
	...
	if !lOk
		...
		Processa( { |lEnd| ProcRegua( nRecs ), lOk := xAC12001Grv( @lEnd, aFiles[1,1] ) .and. xAC12002Grv( @lEnd, aFiles[2,1] ) .and. xAC12003Grv( @lEnd, aFiles[3,1] ) .and. xAC12004Grv( @lEnd, aFiles[4,1] ) }, 'Gravação em andamento' )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC12001Grv( lEnd, cTitulo )
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC12002Grv( lEnd, cTitulo )
Local cFilJAH	:= xFilial("JAH")	// Criada para ganhar performance
Local i			:= 0
Local cCurso
Local cMemo
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC12003Grv( lEnd, cTitulo )
Local cFilJAH	:= xFilial("JAH")	// Criada para ganhar performance
Local i			:= 0
Local cCurso
Local cMemo
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function xAC12004Grv( lEnd, cTitulo )
Local cFilJAH	:= xFilial("JAH")	// Criada para ganhar performance
Local i			:= 0
Local cCurso
Local cMemo
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³xAC120CH  ºAutor  ³Rafael Rodrigues    º Data ³  13/12/02   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
User Function xAC120PL( lEnd, cLog, cLogFile )
Local lRet		:= .T.
Local cChave	:= ""
Local nLinha	:= 0
Local lLog		:= cLog <> NIL
