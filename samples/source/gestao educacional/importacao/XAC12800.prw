...
ฑฑบPrograma  ณxAC12800  บAutor  ณRafael Rodrigues    บ Data ณ  17/12/02   บฑฑ
...
if Empty( aTables )	//Nenhum arquivo importado.
	...
	aAdd( aObrig, { 'U_xACIsHora(JBD_HORA1, .F.)', 'Horแrio inicial nใo informado ou invแlido.' } )
	aAdd( aObrig, { 'U_xACIsHora(JBD_HORA2, .F.)', 'Horแrio final nใo informado ou invแlido.' } )
	aAdd( aObrig, { '!U_xACIsHora(JBD_HORA1, .F.) .or. !U_xACIsHora(JBD_HORA2, .F.) .or. JBD_HORA1 <= JBD_HORA2', 'Horแrio inicial maior que o horแrio final.' } )
	...
	Processa( { |lEnd| lOk := U_xACChkInt( "TRB", "JBC_CODIGO+JBD_ITEM", .F., aObrig, cLog, @lEnd, if( lForceLog, cLogFile, nil ) ) .and. lOk, lOk := U_xAC128SP( @lEnd, cLog, if( lForceLog, cLogFile, nil ) ) .and. lOk }, 'Valida็ใo do Arquivo' )
	...
	if !lOk
		...
		Processa( { |lEnd| lOk := xAC12800Grv( @lEnd ) }, 'Grava็ใo em andamento' )
...
ฑฑบPrograma  ณxAC12800GrvบAutor  ณRafael Rodrigues   บ Data ณ  17/12/02   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯอออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRealiza a gravacao dos dados na base do AP6.                บฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณxAC12800                                                    บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function xAC12800Grv( lEnd )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณxAC128SP  บAutor  ณRafael Rodrigues    บ Data ณ  17/12/02   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xAC128SP( lEnd, cLog, cLogFile )
Local lRet		:= .T.
Local lLog		:= cLog <> NIL
Local cChave
Local cHora
