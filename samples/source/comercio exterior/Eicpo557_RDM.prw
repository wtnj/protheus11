...
WHILE .T.
  ...
  nLin:=1.4 ; nColS1:=1.0  ; nColG1:=7.0 ; nColS2:=17.0 ; nColG2:=21.0
      ...
      oSend(TGet(),"New",nLin         ,nColG1 ,bSetGet(TPO_Num)   ,oDlg,40,8,;
   ...
   V:=oSend(TGet(),"New",nLin         ,nColG2 ,bSetGet(TImport)   ,oDlg,10,8,;
      ...
      oSend(TGet(),"New",nLin         ,nColG1 ,bSetGet(TNr_Pro)   ,oDlg,50,8,;
   ...
   V:=oSend(TGet(),"New",nLin         ,nColG1 ,bSetGet(TPais)   ,oDlg,50,8,,,,,oFntDlg,,,.F.,,,,,,,,,)
      oSend(V,"DISABLE")
...
WHILE !SW3->(EOF()) .AND. SW3->W3_PO_NUM==TPO_Num .AND. SW3->W3_FILIAL==xFilial("SW3")
   ...
   Work->WKPRECO := SW3->W3_PRECO * IF(SW2->W2_PARID_U==0,1,SW2->W2_PARID_U)
   Work->WKAMOUNT:= SW3->W3_QTDE * ( SW3->W3_PRECO * IF(SW2->W2_PARID_U==0,1,SW2->W2_PARID_U) )
...
AVPRINT oPrn NAME STR0043 //"Proforma Invoice"
   ...
   AVPAGE
        ...
        WHILE !SW3->(EOF()) .AND. SW3->W3_FILIAL==xFilial("SW3") .AND. ;
           ...
           oPrn:Say( nLinha           ,1710 ,trans(SW3->W3_PRECO* IF(SW2->W2_PARID_U==0,1,SW2->W2_PARID_U),E_TrocaVP(1,_PictPrUn)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
           oPrn:Say( nLinha           ,2190 ,trans(SW3->W3_QTDE*(SW3->W3_PRECO* IF(SW2->W2_PARID_U==0,1,SW2->W2_PARID_U)),E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        ...
        oPrn:Say( nLinha    ,2190 ,trans(SW2->W2_FOB_TOT* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        PARTE2:=2
        lBateBox:=.F.
        PO557VERFIM()
        oPrn:Say( nLinha:=nLinha+50, 130  ,STR0047,aFontes:TIMES_NEW_ROMAN_12) //"INTERNATIONAL FREIGHT"
        oPrn:Say( nLinha    ,2190 ,trans(SW2->W2_FRETEIN* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        PARTE2:=2
        lBateBox:=.F.
        PO557VERFIM()
        oPrn:Say( nLinha:=nLinha+50, 130  ,STR0048 ,aFontes:TIMES_NEW_ROMAN_12) //"INLAND"
        oPrn:Say( nLinha    ,2190 ,trans(SW2->W2_INLAND* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        PARTE2:=2
        lBateBox:=.F.
        PO557VERFIM()
        oPrn:Say( nLinha:=nLinha+50, 130  ,STR0049 ,aFontes:TIMES_NEW_ROMAN_12) //"PACKING"
        oPrn:Say( nLinha    ,2190 ,trans(SW2->W2_PACKING* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        PARTE2:=2
        lBateBox:=.F.
        PO557VERFIM()
        oPrn:Say( nLinha:=nLinha+50, 130  ,STR0050,aFontes:TIMES_NEW_ROMAN_12) //"DISCOUNT"
        oPrn:Say( nLinha    ,2190 ,trans(SW2->W2_DESCONT* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        PARTE2:=2
        lBateBox:=.F.
        PO557VERFIM()
        oPrn:Say( nLinha:=nLinha+50, 130  ,STR0051+SW2->W2_INCOTER ,aFontes:TIMES_NEW_ROMAN_12) //"TOTAL "
        oPrn:Say( nLinha    ,2190 ,trans((SW2->W2_FOB_TOT+SW2->W2_FRETEIN+SW2->W2_INLAND+SW2->W2_PACKING-SW2->W2_DESCONT)* SW2->W2_PARID_U,E_TrocaVP(1,_PictPrTot)),aFontes:TIMES_NEW_ROMAN_12,,,,1)
        nLi_Fim2:=(nLinha+50)
...
oPrn:Say( nLinha            , 1480,STR0064,aFontes:TIMES_NEW_ROMAN_12 ) //"UNIT US$"
oPrn:Say( nLinha            , 1880,STR0065,aFontes:TIMES_NEW_ROMAN_12 ) //"TOTAL US$"
oPrn:Line(nLinha:=nLinha+50 , 110, nLinha  , 2240 )
oPrn:Line( nLinha+1,  110, nLinha+1, 2240 )
SysRefresh()
RETURN NIL
...
oPrn:Say( nLinha:=nLinha+20 , 1120 , STR0069,aFontes:TIMES_NEW_ROMAN_12 ) //"PAYMENT:"
W:=1
nLinPay := 0
