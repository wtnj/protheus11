...
IF !EMPTY(cMemo)          
  Linha := Linha +70
  FOR I:=1 TO MLCOUNT(cMemo,100)
    oPrn:Say( Linha:=Linha+70, 200 ,MEMOLINE( cMemo,100,I),aFontes:TIMES_NEW_ROMAN_14) //"PLEASE  FIND  ATTACHED  OUR  PURCHASE  ORDER  AND  CONFIRM  THE"
  NEXT  
ELSE
