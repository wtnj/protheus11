...
Begin Sequence
   ...
   DEFINE MSDIALOG oDlg TITLE STR0013 FROM 9,0 TO 28,80 OF oMainWnd //"Seleção de Processos"
...
Begin Sequence
   ...
   IF Empty(cRet)
      HELP(" ",1,"AVG0005053") //MsgInfo("Não há processos selecionados para a impressão !","Aviso")
   Endif
End Sequence
