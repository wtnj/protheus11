...
#DEFINE APSWDET_USER_ ID                aPswDet[01][ 01]
#DEFINE APSWDET_USER_ NAME            aPswDet[01][ 02]
#DEFINE APSWDET_USER_ PWD            aPswDet[01][ 03]
#DEFINE APSWDET_USER_ FULL_NAME    aPswDet[01][ 04]
#DEFINE APSWDET_USER_ GROUPS        aPswDet[01][ 10]
#DEFINE APSWDET_USER_ DEPARTMENT    aPswDet[01][ 12]
#DEFINE APSWDET_USER_ JOB            aPswDet[01][ 13]
#DEFINE APSWDET_USER_ MAIL            aPswDet[01][ 14]
#DEFINE APSWDET_USER_ STAFF            aPswDet[01][ 22]
#DEFINE APSWDET_USER_ DIR_PRINTER    aPswDet[02][ 03]
#DEFINE APSWDET_USER_ MENUS            aPswDet[03]
...
Static Function ChgUsrInf(__ cUser)
Local aPswDet
...
IF ( ( nPswRec := spf_seek( cPswFile , "2U"+cUserId , 1 ) ) <= 0 )
...
If .F. // ativar este trecho para mudanca de e-mail em massa
    ...
    If ! Empty(_cEmail) .And. "@DOMINIO_ANTERIOR" $ Upper(_cEmail)
        ...
        aPswDet[01][ 14] := APSWDET_USER_ MAIL := __cEmail
...
spf_Update( @cPswFile, @nPswRec, "1U"+APSWDET_USER_ ID , Upper("1U"+APSWDET_USER_ NAME) , "1U"+APSWDET_USER_ PWD , @cPswDet )
