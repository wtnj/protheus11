...
±±ºPrograma ³SD3250I  Autor ³Guilherme Demétrio Camargo º Data 07/05/2013 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³     Gera o desmonte do item RT01.000001 no armazém 22      º±±
±±º          ³     para MP01.000004                                       º±±
		...
		If(SB1->(DbSeek(xFilial("SB1") + TRA1->D3_COD)))			
			...
			Else
				aAdd(aArray,{	SB1->B1_COD,;					// 01.Produto Origem
								...
								CRIAVAR("D3_OPERACA",.F.),;		// 25.Operação
