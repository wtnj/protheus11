...
Local cInfAdPr    := SuperGetMV("MV_INFADPR", .F.,"2") 
Local cInfAdPed   := ""
		...
		Else
			...
			If !Empty(SF2->F2_DUPL)	
				...
				While !Eof() .And. xFilial("SE1") == (cAliasSE1)->E1_FILIAL .And.;
					...
					SF2->F2_DOC == (cAliasSE1)->E1_NUM     
						If (cAliasSE1)->E1_TIPO = MVNOTAFIS .OR. (((cAliasSE1)->E1_ORIGEM $ 'LOJA701|FATA701|LOJA010') .AND. (cAliasSE1)->E1_TIPO $ cWhere)
							If cValLiqB == "1"
			...
			#IFDEF TOP
				...
				BeginSql Alias cAliasSD2
						...
						D2_CLASFIS,D2_PRCVEN,D2_CODISS,D2_DESCZFR,D2_PREEMB,D2_DESCZFC,D2_DESCZFP,D2_LOTECTL,D2_NUMLOTE,D2_ICMSRET,D2_VALPS3,
...
//						If MsSeek(xFilial("SD2")+(cAliasSD2)->D2_NFORI+(cAliasSD2)->D2_SERIORI+(cAliasSD2)->D2_CLIENTE+(cAliasSD2)->D2_LOJA+(cAliasSD2)->D2_COD+(cAliasSD2)->D2_ITEMORI)
				...
				aadd(aProd,	{Len(aProd)+1,; 
					/* WHB INICIO */ _cCod,; // (cAliasSD2)->D2_COD,; //-- WHB FIM
					...
					(cAliasSD2)->D2_NUMLOTE,;//Numero do Lote
				   	IIF((cAliasSD2)->D2_TIPO == "D" .Or. lConsig ,(cAliasSD2)->D2_DESPESA + (cAliasSD2)->D2_VALPS3 + (cAliasSD2)->D2_VALCF3 + (cAliasSD2)->D2_VALIPI , (cAliasSD2)->D2_DESPESA + (cAliasSD2)->D2_VALPS3 + (cAliasSD2)->D2_VALCF3),;      //Outras despesas + PISST + COFINSST  (Inclus„o do valor de PIS ST e COFINS ST na tag vOutros - NT 2011/004).E devoluÁÁ„o com IPI.
				...
				If (cAliasSD2)->D2_TIPO == "D"  .Or. lConsig
