...
±±ºPrograma  ³NHGPE066  ºAutor  ³Marcos R Roquitski  º Data ³  24/04/06   º±±
...
Cabec1    := " C.Custo       Descricao C.Custo                     Sal.Nominal         H.Extras            DSR       Despesas       T O T A L    Prov. Ferias    Prov.13o.Sal    Enc.Sal.104%    Enc.Extr.73%"
...
While TMP->(!eof())
	...
	While TMP->RD_CC == _cCusto
		fTotHrm()
		@ Prow()   , 051 PSAY Transform(_nVlNormal,"@E 999,999,999.99")
		@ Prow()   , 068 PSAY Transform(_nVlExtras,"@E 999,999,999.99")
		@ Prow()   , 083 PSAY Transform(_nVlDsr,"@E 999,999,999.99")
		@ Prow()   , 098 PSAY Transform(_nVlOutras,"@E 999,999,999.99")
		_nTotG0 := (_nVlNormal + _nVlExtras + _nVlDsr + _nVlOutras)
		@ Prow()   , 114 PSAY Transform(_nTotG0,"@E 999,999,999.99")
		@ Prow()   , 130 PSAY Transform(_nVlFerias,"@E 999,999,999.99")
		@ Prow()   , 146 PSAY Transform(_nVl13,"@E 999,999,999.99")

		@ Prow()   , 162 PSAY Transform(((_nVlNormal*104)/100),"@E 999,999,999.99")
		@ Prow()   , 178 PSAY Transform(((_nVlExtras100*73)/100),"@E 999,999,999.99")
...
_nVlFerias := 0
SRT->(DbSetOrder(2))
SRT->(DbSeek(xFilial("SRT") + _cCusto))
While SRT->(!eof()) .AND. _cCusto == SRT->RT_CC
