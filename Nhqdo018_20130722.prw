...
User Function NhQdo018(_pInclui)
	...
	Elseif SM0->M0_CODIGO == 'FN' // WHB FUNDICAO
		...
		Elseif Alltrim(M->QDH_CODTP) $  'DFJ/FIU/LFU/MTU/PCU/PKU/LFV/PCV/PKV/MMU/DCA/PKA'//RETIRADO O PKJ POR SOLICITAÇÃO DA FABIANA. OS 47477 - Retirado o DCJ e PCJ a pedido do Felipe Peres (Forjaria)
