...
±±ºPrograma  ³NHGPE241  ºAutor  ³Marcos R Roquitski  º Data ³  25/04/2013 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Gera arquivo holerite Mensal DLL Informatica.              º±±
±±º          ³                                                            º±±
...
If !Empty(TMP0->RA_MAT) 
	cArqDep := "C:\RELATO\ITHOB"+SM0->M0_CODFIL + Substr(Dtos(dDataBase),5,4) + ".REM" // Deposito
	cFnl    := CHR(13)+CHR(10)
